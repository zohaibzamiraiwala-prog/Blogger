...
$stmt = $conn->prepare("SELECT * FROM posts WHERE title LIKE ? OR content LIKE ? ORDER BY publish_date DESC");
...
<body>
    <div class="container">
        <h1 class="text-center mb-4">Search Results for "<?php echo htmlspecialchars($q); ?>"</h1>
